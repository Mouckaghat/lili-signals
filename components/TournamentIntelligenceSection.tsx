...
// The formation win/loss table (🧩 Tactics) now lives in its own reusable
// component so the Dashboard and this tab share one source of truth.
// See components/FormationRecord.tsx.
